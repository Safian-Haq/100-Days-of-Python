...
class CafeForm(FlaskForm):
    ...
    rating = SelectField('Coffee Rating', validators=[DataRequired()], choices=['☕'*i for i in range(1,6)])
    wifi = SelectField('Wifi Strength Rating', validators=[DataRequired()], choices=['✘'] + ['💪'*i for i in range(1,6)])
    power = SelectField('Power Rating', validators=[DataRequired()], choices=['✘'] + ['🔌'*i for i in range(1,6)])
